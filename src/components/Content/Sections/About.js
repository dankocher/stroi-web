...
const LeftSide = props => {
    return <div className="a-s a-left">
        ...
        <SectionDescription text={'НАЗВАНИЕ_КОМПАНИИ предлагает полный комплекс работ по строительству домов и коттеджей, проектированию, изготовлению и монтажу металлоконструкций, отделке помещений, проводит кровельные и фасадные работы, установку коммуникаций.'}/>
        ...
        <SectionDescription text={'Строительные бригады состоят из профессионалов своего дела. Наши специалисты берутся за работу любой сложности и всегда найдут оптимальные решения для самых изысканных Ваших желаний. Компания НАЗВАНИЕ_КОМПАНИИ берет на себя все хлопоты и проблемы, связанные со строительными работами.'}/>
...
const LeftAbout = props => {
    return <div className="s-a l-about">
        <SectionDescription text={'НАЗВАНИЕ_КОМПАНИИ основано в 2019 году. Основным видом деятельности предприятия является ремонтно-строительные работы с применением современных технологий строительства и использованием прогрессивных стройматериалов.'}/>
