        ...
        return <div className="header" style={{height: height}}>
            <header className="App-header">
                <img src={banner}
                     ...
                     className="app-banner" alt="Ремонтны услуги" />
                <div ref={content => this.content = content} className={`h-content${width < 1000 && showMenu ? ' -show-menu' : ''}`}>
                    <h1 className="-text">Строительные услуги</h1>
                    <h5 className="-text -sub">Быстро, качественно и недорого</h5>
                    {/*<ButtonCallMe/>*/}
                </div>
            </header>
        </div>
